...
<!-- Plugin description -->
A minimalist and clear theme for your exciting days.
...
- Using IDE built-in plugin system:
  ...
  <kbd>Settings/Preferences</kbd> > <kbd>Plugins</kbd> > <kbd>Marketplace</kbd> > <kbd>Search for "dayTheme"</kbd> >
  <kbd>Install Plugin</kbd>
  
- Manually:

  Download the [latest release](https://github.com/MichaelPaulHP/dayTheme/releases/latest) and install it manually using
